...
function gameLogic() {
    ...
    } else clearInterval(runGame), button !== null && (button.innerHTML == "Sound: on" && safePlay("gameover")), grid = [], food = [], fruit = [], enemy = [], powerup = [], jump = 0, foodSpawn = 0, fruitSpawn = randomIntFromInterval(150, 80), enemySpawn = 30, powerupSpawn = randomIntFromInterval(250, 60), localStorage.getItem("highScore") < score && localStorage.setItem("highScore", score), setTimeout(function () {
